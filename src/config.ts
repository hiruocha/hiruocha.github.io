...
export const siteConfig: SiteConfig = {
	title: "昼お茶的个人小站",
	subtitle: "",
	siteURL: "https://hiruocha.is-a.dev/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2025-06-18", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	bangumi: {
		userId: "hiruocha", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
	},
	...
	font: {
		...
		asciiFont: {
			...
			fontWeight: "500",
			localFonts: ["NotoSans-Medium.ttf"],
		...
		cjkFont: {
			...
			fontWeight: "500",
			localFonts: ["NotoSansCJKsc-Medium.otf"],
			enableCompress: true, // 启用字体子集优化，减少字体文件大小
		},
	},
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/hiruocha",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/687234999",
					external: true,
					icon: "fa6-brands:bilibili",
				},
				{
					name: "Codeberg",
					url: "https://codeberg.org/hiruocha",
					external: true,
	...
	links: [
		{
			name: "E-Mail",
			icon: "mdi:email",
			url: "mailto:hiruocha@gmail.com",
		},
		{
			name: "Matrix",
			icon: "simple-icons:matrix",
			url: "https://matrix.to/#/@hiruocha:mozilla.org",
		},
		{
			name: "Telegram",
			icon: "mdi:telegram",
			url: "https://t.me/hiruocha",
		},
	],
};
